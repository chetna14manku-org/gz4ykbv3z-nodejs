...
export IMAGE_URL=${IMAGE_URL-quay.io/chetna14manku_org/rhtap-qe:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/chetna14manku-org/gz4ykbv3z-nodejs-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-vbz6j.vbz6j.sandbox1209.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-vbz6j.vbz6j.sandbox1209.opentlc.com}
